...
async function showMealDetails(id) {
    ...
    await fetchMealsFromApi(url, id).then(data => {
        cardDetails += `
          <div id="meal-details" class="mb-5">
            ...
            <div id="meal-instruction" class="mtcards
    ...
    document.getElementById("main").innerHTML = cardDetails;
}
...
async function showFavMealList() {
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            ...
                            <div class="mb-4 lead">
                          <h2 class="text-xl"> you haven't add anything yet !</h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    document.getElementById("favourites-body").innerHTML = favList;
}
...
function addRemoveToFavList(id) {
    ...
    if (contain) {
        ...
        arr.push(id);
        alert("your meal add in favourites list");
    }
